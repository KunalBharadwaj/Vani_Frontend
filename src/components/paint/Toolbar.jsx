...
import {
  ...
  Trash2, PaintBucket, Palette, Upload, Highlighter, Check, ScanSearch
} from "lucide-react";
...
export const Toolbar = ({
  ...
  return (
    <div className="flex items-center gap-0.5 px-1 py-0.5">
      ...
      <ToolButton icon={ScanSearch}  label="Magic Search" shortcut="M" isActive={activeTool === "magic_search"} onClick={() => onToolChange("magic_search")} />
